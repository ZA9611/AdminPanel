                                                        ...
                                                        @foreach(json_decode($row->default_values) as $options)
                                                            @if($options != null)
                                                                <div class="checkbox form-check form-check-inline">
                                                                    <label class="form-check-label">
                                                                        <input type="checkbox" name="{{ 'checkbox[' . $row->name . '][]' }}" value="{{$options}}" {{($row->is_required===1)?"required":''}}> {{ ucfirst(str_replace('_', ' ', $options)) }}
                                                                    </label>
                                                                </div>
                                                            @endif
                                                        @endforeach
